   <!-- Page Header Ends        -->
      ...
      <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper"> 
          <div>
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="{{url('Admin/assets/images/logo/small-logo.pn')}}" alt=""><img class="img-fluid for-dark" src="{{url('Admin/assets/images/logo/small-white-logo.png')}}" alt=""></a>
              <div class="back-btn"><i class="fa fa-angle-left"></i></div>
            </div>
            <div class="logo-icon-wrapper"><a href="index.html"><img class="img-fluid" src="{{url('Admin/assets/images/logo-icon.png')}}"alt=""></a></div>
            <nav class="sidebar-main">
              <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  <li class="back-btn"><a href="index.html"><img class="img-fluid" src="{{url('Admin/assets/images/logo-icon.pn')}}" alt=""></a>
                    <div class="mobile-back text-end"><span>Back</span><i class="fa fa-angle-right ps-2" aria-hidden="true"> </i></div>
                  </li>
                  <li class="sidebar-list">
                    <label class="badge badge-light-primary"></label><a class="sidebar-link sidebar-title" href="{{url('admindashboard')}}">
                   ...
                   <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{url('AdminUserlist')}}">Userlist</a></li>
                  ...
                  <ul class="sidebar-submenu">
                    ...
                    <li><a href="{{url('Adminproduct')}}">ProductList</a></li>
                  </ul>
                </li>
                  {{-- <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="https://admin.pixelstrap.com/zeta/starter-kit/index.html" target="_blank">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g>
